 ...
 * tailleY: taille en hauteur du bouton position: gauche ou droite couleur: couleur de base 
 * texteCouleur: couleur du texte onclick: callback onclick arrondie: taille de l'arrondie de la bordure 
 * texte : texte affiché sur le bouton cible : balise dans laquelle insérer le bouton */
function createButton(tailleX, tailleY, gauche, couleur, texteCouleur, onclickCallback, arrondie, texte, cible) {
    let bouton = document.createElement("button");

    bouton.setAttribute("type", "button"); bouton.appendChild(document.createTextNode(texte)); bouton.setAttribute("onClick", onclickCallback);
